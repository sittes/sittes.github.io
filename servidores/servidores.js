...
(function(global) {
    ...
    function applyc(__$ctx, __$ref) {
        ...
        if (__$t === "content") {
            ...
            if (__$t === "page") {
                ...
                var __$t = !$$elem;
                if (__$t) {
                    if ((!$$mods.type || $$mods.type === "submit") && (__$ctx.__$a0 & 32) === 0) {
            ...
            } else if (__$t === "control-pane") {
                if (!$$elem) {
                    return true;
                }
            } else if (__$t === "mesosphere") {
                if (!$$elem) {
                    return {
                        servers: __$ctx._data.servers,
                        runnedApps: __$ctx._data.runnedAps
                    };
                }
            }
            return undefined;
            ...
            if (!__$ctx._data && (__$ctx.__$a0 & 128) === 0) {
    ...
    function __$b4(__$ctx, __$ref) {
        var list__$29, data__$30 = __$ctx._data.app_storage, isData__$31 = Boolean(data__$30.length), apps__$32 = [ {
            elem: "title",
        ...
        if (isData__$31) {
            apps__$32.push({
                elem: "list",
                content: data__$30.map(function(app) {
                    return {
                        block: "app",
                        mods: {
                            id: app.id
            ...
            apps__$32[0].content = "No Apps";
        }
        return apps__$32;
    }
    
    function __$b5(__$ctx, __$ref) {
        var servers__$26 = __$ctx._data.servers, content__$27 = [ {
            elem: "title",
            content: "Server Canvas"
        } ];
        if (servers__$26.length) {
            content__$27.push({
                elem: "list",
                content: servers__$26.map(function(server) {
                    var appsNum__$28 = server.apps.length;
                    return {
                        block: "server",
                        mods: {
                            apps: appsNum__$28
            ...
            content__$27.push("No servers");
        }
        return content__$27;
    }
    
    function __$b7(__$ctx, __$ref) {
        var ctx__$36 = __$ctx.ctx, content__$37 = [ ctx__$36.icon ];
        "text" in ctx__$36 && content__$37.push({
            elem: "text",
            content: ctx__$36.text
        });
        return content__$37;
    }
    
    function __$b14(__$ctx, __$ref) {
        var ctx__$38 = __$ctx.ctx, attrs__$39 = {
            type: $$mods.type || "button",
            name: ctx__$38.name,
            value: ctx__$38.val
        };
        $$mods.disabled && (attrs__$39.disabled = "disabled");
        return __$ctx.extend(function __$lb__$40() {
            var __$r__$41;
    ...
    function __$b15(__$ctx, __$ref) {
        ...
        return {
            role: "button",
            tabindex: ctx__$43.tabIndex,
            id: ctx__$43.id,
            title: ctx__$43.title
        };
    }
    ...
    function __$b51(__$ctx, __$ref) {
        var that__$14 = __$ctx;
        __$ctx.ctx.js = {
            apps: []
        };
        __$ctx.ctx.mods = __$ctx.ctx.mods || {};
        function getAppDetails__$15(app) {
            var appsStorage__$16 = that__$14._data.app_storage;
            for (var i__$17 = 0; i__$17 <= appsStorage__$16.length; i__$17++) {
                if (appsStorage__$16[i__$17].id == app.id) return that__$14._.extend(appsStorage__$16[i__$17], app);
            }
        }
        if (__$ctx.ctx.mods.apps != 0) {
            __$ctx.ctx.content = {
                elem: "apps",
                content: __$ctx.ctx.apps.map(function(app) {
                    var appDetails__$18 = getAppDetails__$15(app);
                    that__$14.ctx.js.apps.push(appDetails__$18);
                    that__$14.ctx.mods[appDetails__$18.id] = appDetails__$18.timestamp;
                    return {
                        elem: "app",
                        elemMods: {
                            type: appDetails__$18.id
                        },
                        content: [ {
                            elem: "app-abbr",
                            content: appDetails__$18.abbr
                        }, {
                            elem: "app-name",
                            content: appDetails__$18.name
                        }, {
                            elem: "app-timestamp",
                            content: appDetails__$18.timestamp
                        } ]
                    };
                })
            };
    ...
    function __$b62(__$ctx, __$ref) {
        ...
        __$ctx._data.runnedAps = function() {
            var runned__$61 = {};
            this._data.servers.forEach(function(server) {
                server.apps.forEach(function(app) {
                    if (runned__$61[app.id]) {
                        runned__$61[app.id] = runned__$61[app.id] + 1;
                    } else {
                        runned__$61[app.id] = 1;
                    }
                });
            });
            return runned__$61;
                ...
                return [ __$ctx.ctx.name, {
                    ...
                    content: [ {
                        ...
                        mods: {
                            "for": "app",
                            action: "kill",
                            disabled: __$ctx.ctx.instances ? false : "yes"
                        },
                        text: "-"
                    }, {
                        block: "button",
    ...
    function __$g1(__$ctx, __$ref) {
        ...
        if (__$t === "page") {
            ...
            var __$t = $$elem;
            if (__$t === "app-timestamp") {
                return "p";
            } else if (__$t === "app-name") {
                return "h4";
            } else if (__$t === "app-abbr") {
                return "h3";
            } else if (__$t === "app") {
                return "li";
            } else if (__$t === "apps") {
    ...
    */
     ...
     * @see https://code.jquery.com/jquery-migrate-1.1.1.js
     */
    ...
    /* begin: ../../desktop.blocks/mesosphere/mesosphere.js */
    /**
     * @module mesosphere
     */
    ...
    /* end: ../../desktop.blocks/mesosphere/mesosphere.js */
    /* begin: ../../desktop.blocks/control-pane/control-pane.js */
    /**
     * @module control-pane
     */
    ...
    /* end: ../../desktop.blocks/control-pane/control-pane.js */
    ...
    // NOTE: Remove jQuery special fixes for pointerevents â€“ we fix them ourself
    ...
    /* begin: ../../desktop.blocks/app/app.js */
    /**
     * @module app
     */
    ...
    /* end: ../../desktop.blocks/app/app.js */
    /* begin: ../../desktop.blocks/server-canvas/server-canvas.js */
    /**
    ...
    /* end: ../../desktop.blocks/server-canvas/server-canvas.js */
